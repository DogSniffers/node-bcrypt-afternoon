...
export default class Container extends Component {
  ...
  getDragonTreasure() {
    axios.get('/api/treasure/dragon').then(res => this.setState({treasures: {...this.state.treasures, dragon:res.data}}
      ))
  }

  getAllTreasure() {
    axios.get('/api/treasure/all').then(res => this.setState({treasures:{...this.state.treasures, all:res.data}})).catch(error => alert(error.response.request.response))
    // axios GET to /api/treasure/all here
  }

  getMyTreasure() {
    axios.get('/api/treasure/user').then(res => this.setState({treasures: {
      ...this.state.treasure, user:res.data}}
      )).catch(error => alert(error.request.response.response))
